...
@ApiModel(value="采购退回详细",description="采购退回详细")
@Data
public class BuyBackBill_d implements Serializable {
    ...
    @ApiModelProperty(value = "单价",name="salePrice",required=true)
    ...
    private int ord;//备注
    @ApiModelProperty(value = "入库行号",name="rkOrd",required=true)
    private int rkOrd;//入库行号
}
